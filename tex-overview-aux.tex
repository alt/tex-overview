...
\cs_gset:Nn\addtotextviews:f{\tl_gput_right:No\settextviews{#1}}
...
%% test if we are in the short or full view
  ...
  \addtotextviews:f{\subsubsection*{\color{blue}#5}\parbox{\textwidth}{#4}}
  }
}
...
%%% maybe this will be used again in the part commands
...
\NewDocumentCommand{\overviewsubsection}{omO{\tonodestyle}}{
  \bool_if:NTF\to_short
  {
    \tl_set:Nn\to_mandsubsect{#2, short view}
...
\NewDocumentCommand{\overviewsubsubsection}{omO{\tonodestyle}}{
  \bool_if:NTF\to_short
  {
    \tl_set:Nn\to_mandsubsubsect{#2, short view}
...
\AtBeginDocument{
  {
    ...
    \flushright
    \Large \color[rgb]{.4 0 0} Arno Trautmann\\ \fontsize{9.85}{10}\selectfont arno.trautmann@gmx.de\par
  }
}