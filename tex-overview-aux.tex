%% This document is part of the document tex-overview. It only contains the formatting and definitions for typesetting.
...
\makeatletter
\def\l@section#1#2{ % this is not neat, but seemingly the only way to reduce the space between sections in toc.
