...
\setlayer{-4}
\mynode{enctex}{5.6,\layer}{A small extension to TeX, started 1997. Adds 10 new primitives relating input re-encoding}{enc\TeX};
\draw (tex3) to (enctex);
...
\mynode{lualatex}{7,-6}{LaTeX based on LuaTeX with pdf (standard) or dvi (dviLuaLaTeX) output.}{(dvi)Lua\LaTeX};
