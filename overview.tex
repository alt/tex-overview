...
\mynode[\experimental]{vtex}{3.6,\layer}{VTeX (only for linux/OS 2) can produce pdf directly from input. In contrast to pdfTeX, it includes a full PostScript interpreter, thus capable to include EPS figures, PStricks etc.}{V\TeX};
\draw (etex) to (vtex);
