...
\tograph(\tostruct(1)[Bib\TeX]{Bib\TeX}){
	...
	\tonode[\package](librarian)(8,\layer)<A TeX file (useable with all formats) that typesets BibTeX-style bibliographies without the need of BibTeX. Therefore, it provides a format-independent typesetting of bibliographies.>{Librarian}
}
