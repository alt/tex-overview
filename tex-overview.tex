...
\tostruct(0)[Distributions]{Distributions}[\distro]
\parbox{\textwidth}{\normalsize
...
\tograph(\tostruct(1)[Bib\TeX]{Bib\TeX}){
	...
	\tonode(biber)(0,\layer)<A perl implementation of a BibTeX-like program, designed for (?) use with BibLaTeX. "biber" is an animal handling bibliographies. (german for "beaver", hence the beaver in the biber logo)>{biber}
	\todraw(bibtexu)(biber)
